...
public final class MaceratorSupport {
    ...
    public static void addRecipe(IItemStack output, IIngredient input) {
        CraftTweakerActions.apply(new SimpleIC2RecipeAction(Recipes.macerator, IC2RecipeInputs.of(input), null, CraftTweakerMC.getItemStack(output)));
    }
    ...
    public static void removeRecipe(IItemStack output, IItemStack... input) {
        ...
        CraftTweakerActions.apply(new SimpleIC2RecipeRemovalAction(Recipes.macerator, nativeOutput, nativeInputs));
    }
}
